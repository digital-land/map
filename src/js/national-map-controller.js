/* global L, fetch, ZoomControls, LayerControls, AbortController */
...
NationalMapController.prototype.initControls = function () {
  ...
  this.zoomComponent = new ZoomControls(this.$zoomControls, this.map, this.defaultZoomLevel).init({})
  const boundToggleDataLayer = this.toggleDataLayer.bind(this)
  this.layerControlsComponent = new LayerControls(this.$layerControls, this.map).init({
